...
import com.xchengtech.ProjectConfig;//caowen add 20160825
...
public class VideoMode extends CameraMode implements MediaRecorder.OnErrorListener,
    ...
    protected void initializeShutterStatus() {
        ...
        //caowen modify for BUG-ID:SWYYWAZUMI-4 front camera support Vss 20160825 start
        //if (CameraInfo.CAMERA_FACING_FRONT == mICameraDeviceManager
		if (!ProjectConfig.XC_FRONT_CAMERA_VIDEO_SNAPSHOT_SUPPORT && 
            ...
            mICameraAppUi.setPhotoShutterEnabled(false);
        } else if (ProjectConfig.XC_FRONT_CAMERA_VIDEO_SNAPSHOT_SUPPORT){
			
			mICameraAppUi.setPhotoShutterEnabled(true);
        } 
		//caowen modify for BUG-ID:SWYYWAZUMI-4 front camera support Vss 20160825 end	
		else {
