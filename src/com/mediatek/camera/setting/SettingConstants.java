...
public class SettingConstants {
    ...
    //add by zhangxiulu 20160119 begin
    public static final String KEY_CAMERA_SHUTTER_SOUND        = "pref_shutter_sound_key";  //suchenglong
    //add by zhangxiulu 20160119 end
    ...
    //add by zhangxiulu 20160119 begin
    public static final int ROW_SETTING_CAMERA_SHUTTER_SOUND      = 61;
    //add by zhangxiulu 20160119 end
    //Add by zhangtao for timestamp (start)
    public static final int ROW_SETTING_CAMERA_TIME_STAMP         = 62;
    //Add by zhangtao for timestamp (end)
    public static final int ROW_SETTING_CAMERA_GRID_LINES		  = 63;
    public static final int SETTING_COUNT                         = 64;  //modify by zhangtao 20160616
    ...
    static {
        ...
        //add by zhangxiulu 20160119 end
        //Add by zhangtao for timestamp (start)
        SETTING_TYPE[ROW_SETTING_CAMERA_TIME_STAMP]        = ONLY_IN_PEFERENCE;
        //Add by zhangtao for timestamp (end)
    ...
    static {
       ...
       //add by zhangxiuilu 20160119 begin
        KEYS_FOR_SETTING[ROW_SETTING_CAMERA_SHUTTER_SOUND]    = KEY_CAMERA_SHUTTER_SOUND;
        //add by zhangxiuilu 20160119 end
        //Add by zhangtao for timestamp (start)
        KEYS_FOR_SETTING[ROW_SETTING_CAMERA_TIME_STAMP]    = KEY_CAMERA_TIME_STAMP;
        //Add by zhangtao for timestamp (end)
    ...
    public static final int[] SETTING_GROUP_COMMON_FOR_TAB = new int[]{
        ...
        //add by zhangxiuilu 20160119 begin
        ROW_SETTING_CAMERA_SHUTTER_SOUND,//camera
        //add by zhangxiuilu 20160119 end
    };
    ...
    public static final int[] SETTING_GROUP_CAMERA_FOR_TAB = new int[]{
        ...
        //Add by zhangtao for timestamp (start)
        ROW_SETTING_CAMERA_TIME_STAMP,
        //Add by zhangtao for timestamp (end)
        ROW_SETTING_CAMERA_GRID_LINES,
    };
