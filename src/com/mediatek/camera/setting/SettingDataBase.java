...
//        video   videopip   smile     gesture   refecous
 ...
 MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_SLOW_MOTION_VIDEO_QUALITY]    = new int[]{
    ...
    static {
        ...
        RESET_STATE_VALUE[SettingConstants.ROW_SETTING_CAMERA_TIME_STAMP]    = new String[]{"off", "on"};
    ...
    static {
        ...
        //add by zhangxiuliu 20160119 begin
        ...
        //add by zhangxiuliu 20160119 begin
        //Add by zhangtao for timestamp (start)
        DEFAULT_VALUE_FOR_SETTING_ID[SettingConstants.ROW_SETTING_CAMERA_TIME_STAMP]    = R.string.pref_camera_time_stamp_default;
        //Add by zhangtao for timestamp (end)
    ...
    static {
        ...
        //add by zhangxiuliu 20160119 end
        //Add by zhangtao for timestamp (start)
        DEFAULT_VALUE_FOR_SETTING[SettingConstants.ROW_SETTING_CAMERA_TIME_STAMP]    = "off";
        //Add by zhangtao for timestamp (end)
