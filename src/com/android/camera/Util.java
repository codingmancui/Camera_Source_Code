...
public class Util {
    ...
    public static class ImageFileNamer {
        ...
        public ImageFileNamer(String format) {
            //Modify by zhangtao 20160612 (start)
            if (com.xchengtech.ProjectConfig.FEATURE_CAMERA_CUSTOMIZE_FILE_NAME) {
                mFormat = new SimpleDateFormat("_yyyyMMdd_HHmmss", Locale.ENGLISH);
            } else {
                mFormat = new SimpleDateFormat(format, Locale.ENGLISH);
            }
            //Modify by zhangtao 20160612 (end)
        }
        ...
        public String generateName(long dateTaken) {
            ...
            if (com.xchengtech.ProjectConfig.FEATURE_CAMERA_CUSTOMIZE_FILE_NAME) {
                result = android.os.Build.MODEL + result;
            }
