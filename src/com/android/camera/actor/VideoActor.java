...
public class VideoActor extends CameraActor {
	...
	private int mCameraID = 1;//tanyejing add for recording take picture 20160817
    ...
    public VideoActor(CameraActivity context, ModuleManager moduleManager, int mode) {
		...
		mCameraID = mCameraActivity.getCameraId();//tanyejing add for recording take picture 20160817
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        //tanyejing add for recording take picture 20160817 start
        Log.i(TAG, "[onKeyDown] keyCode = " + keyCode);
        switch (keyCode) {
        case KeyEvent.KEYCODE_VOLUME_UP:
        case KeyEvent.KEYCODE_VOLUME_DOWN:
		android.util.Log.i("tanyejing","mcamera	ID = " + mCameraID);
		    if(com.xchengtech.ProjectConfig.FEATURE_CUSTOM_RECORDING_CAPTURE_SUPPROT){
				if(mCameraID == 0){
        ...
        //tanyejing add for recording take picture 20160817 end
        return mModuleManager.onKeyDown(keyCode, event);
    }
